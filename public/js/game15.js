...
class GameScene extends Phaser.Scene {
    ...
    updatePlayerVisualPosition(duration = 0) {
        ...
        // הגנה שמונעת קריסה אם מחליפים סקין!
        if (this.playerSprite && this.playerSprite.active) {
            ...
            if (skinConfig && !skinConfig.isDefault) {
    ...
    createPlayer() {
        ...
        // התיקון הקריטי לתקיעות! מאפסים את הזיכרון של הסקינים לפני שיוצרים חדש
        ...
        if (skinConfig.isDefault) {
            ...
            this.eyeGraphics.fillCircle(12, -40, 10); this.eyeGraphics.strokeCircle(12, -40, 10); // התיקון: העין הימנית חזרה!
