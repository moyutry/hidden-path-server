...
class GameScene extends Phaser.Scene {
    ...
    drawRealisticGrid() { 
        if (!this.gridInitialized) {
            ...
            this.trapObjects = {}; 
            this.crystalObjects = []; // הנה הזיכרון של הקריסטלים חזר!
            ...
            // --- 3. אפייה (Baking) חכמה - רק של דברים סטטיים! ---
            for (let row = -1; row <= this.gridSize; row++) {
                ...
                for (let col = -1; col <= this.gridSize; col++) {
                    ...
                    let baseHeight = -15; 
                    let isDynamic = (tileType === 3); // התיקון הקריטי: מלכודות לא נאפות!
                    ...
                    if (!isDynamic) {
                        ...
                        // המלכודות נשארות חירוֹת ומרחפות מעל הרצפה! (לא נהרסות באפייה)
        ...
        // קריאה לפונקציות העדכון בכל פריים של האנימציה
