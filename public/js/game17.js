...
class GameScene extends Phaser.Scene {
        ...
        if (duration > 0) {
            this.tweens.add({
                ...
                onUpdate: (tween) => {
                    ...
                    if (this.playerSprite && this.playerSprite.active) { this.playerSprite.y = -40 - jumpHeight; }
                },
                onComplete: () => {
                    if (this.playerGraphic && this.playerGraphic.active) { this.playerGraphic.y = 0; this.eyeGraphics.y = 0; }
                    if (this.playerSprite && this.playerSprite.active) { this.playerSprite.y = -40; }
    ...
    createPlayer() {
        ...
        if (skinConfig.isDefault) {
            ...
            this.eyeGraphics.fillCircle(12, -40, 10); this.eyeGraphics.strokeCircle(12, -40, 10); // הוספנו את העין הימנית
